<div on:click class="p-4 md:w-1/2 lg:w-1/3">
  <div class="h-full border-2 border-gray-200 rounded-lg overflow-hidden relative">
    ...
    <div class="p-6">
      ...
      <h1 class="title-font text-lg font-bold text-gray-900 mb-3">The CatalyzerCata lyzerCatalyzer</h1>
      <p class="leading-relaxed mb-3">Photo booth fam kinfolk cold-pressed sriracha leggings jianbing microdosing tousled waistcoat.</p>
      <div class="flex items-center flex-wrap ">
        <a class="text-black inline-flex items-center md:mb-2 lg:mb-0 font-bold"> More
