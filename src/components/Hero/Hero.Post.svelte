...
<div class="w-full md:sidebar hero p-8 flex items-center justify-center" style="background: url({content.backgroundImageURL});" >
  <div class="w-full bg-gray-100 rounded-lg overflow-hidden border-bottom-black shadow-md min-h-12 flex flex-col">
    ...
    <div class="p-6">
      <p class="text-center title-font text-lg font-bold text-gray-900 mb-1">
        {content.title}
      </p>
      <p class="text-center tracking-widest text-xs title-font font-medium text-gray-500 mb-1">
        {content.category}
      </p>
